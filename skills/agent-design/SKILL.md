---
name: agent-design
description: Use when architecting an LLM agent — loop shape, tool design, memory tiers, planning patterns (ReAct / Plan-and-Execute / Reflexion), failure modes, eval harnesses, and when NOT to build an agent.
metadata:
  added: 2026-05-19
