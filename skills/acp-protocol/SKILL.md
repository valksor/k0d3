---
name: acp-protocol
description: Use when integrating the Agent Client Protocol (ACP) — Zed's editor↔agent protocol. JSON-RPC 2.0 envelope, capability negotiation, prompt turns, client fs/terminal, permissions.
metadata:
  added: 2026-05-19
