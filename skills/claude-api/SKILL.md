---
name: claude-api
description: Use when designing against Anthropic's Messages API — model selection, prompt caching, extended thinking, tool use, batch / files / citations, streaming SSE shapes. Language-agnostic; JSON wire only.
metadata:
  added: 2026-05-19
