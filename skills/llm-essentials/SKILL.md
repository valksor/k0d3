---
name: llm-essentials
description: Use when designing any LLM-backed feature regardless of provider — token economics, sampling, structured outputs, retries, eval harnesses, cost guardrails, context-window strategies.
metadata:
  added: 2026-05-19
