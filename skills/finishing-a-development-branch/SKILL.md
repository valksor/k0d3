...
description: Use when implementation is complete, all tests pass, and you need to decide how to integrate the work. Verify tests → Detect environment → Present options (merge / PR / keep / discard) → Execute → Clean up.
metadata:
  added: 2026-05-18
